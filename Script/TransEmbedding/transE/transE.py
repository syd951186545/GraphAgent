...
def data_loader(file):
    ...
    entity_set = set(entity2id.values())
    relation_set = set(relation2id.values())
    triple_list = []
...
if __name__ == '__main__':
    ...
    file1 = "E:/AAAAA/ReforcementReasoning/PreDataSets/tranedFile/"+Name
